      ...
      <div className="flex items-center w-full md:w-[30rem] lg:w-[37.5rem]">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col sm:flex-row gap-3 w-full">
            ...
            />
            <Button className="flex items-center justify-center h-12 gap-2 rounded-lg text-[0.875rem] w-full sm:w-fit px-8 py-2 font-bold text-primaryBtnColor shadow-none">
              Submit{" "}
              <ArrowRight02Icon
                strokeWidth={2}
                size={18}
